...
/* Register CSS Styles */
function gutentag_register_css_styles() {
	if (!is_admin()) {
		global $post, 
			$wp_styles;
		...
		wp_enqueue_style('gutentag-theme-style', get_template_directory_uri() . '/style.css', array(), '1.0.0', 'screen, print');
		
		wp_enqueue_style('gutentag-style', get_template_directory_uri() . '/theme-framework/theme-style' . CMSMASTERS_THEME_STYLE . '/css/style.css', array(), '1.0.0', 'screen, print');
		
		wp_enqueue_style('gutentag-adaptive', get_template_directory_uri() . '/theme-framework/theme-style' . CMSMASTERS_THEME_STYLE . '/css/adaptive.css', array(), '1.0.0', 'screen, print');
		
		wp_enqueue_style('gutentag-retina', get_template_directory_uri() . '/theme-framework/theme-style' . CMSMASTERS_THEME_STYLE . '/css/retina.css', array(), '1.0.0', 'screen');
		
		
		if (is_rtl()) {
			wp_enqueue_style('gutentag-rtl', get_template_directory_uri() . '/theme-framework/theme-style' . CMSMASTERS_THEME_STYLE . '/css/rtl.css', array(), '1.0.0', 'screen');
		}
		...
		// iLightBox skins
		$ilightbox_skin = $cmsmasters_option['gutentag' . '_ilightbox_skin'];
		...
		if (is_dir($style_dir) && get_option('cmsmasters_style_exists_' . 'gutentag')) {
			$cmsmasters_styles_dir = $upload_dir['baseurl'] . '/cmsmasters_styles/';
		}
		
		
		wp_enqueue_style('gutentag-fonts-schemes', $cmsmasters_styles_dir . 'gutentag' . '.css', array(), '1.0.0', 'screen');
	}
}

add_action('wp_enqueue_scripts', 'gutentag_register_css_styles');


/* Register JS Scripts */
function gutentag_register_js_scripts() {
	global $post;
	...
	$cmsmasters_localize_array = array( 
		...
		'project_puzzle_proportion' => 			gutentag_project_puzzle_proportion(), 
		'primary_color' => 						$cmsmasters_option['gutentag' . '_default_link'], 
		'ilightbox_skin' => 					$cmsmasters_option['gutentag' . '_ilightbox_skin'], 
		'ilightbox_path' => 					$cmsmasters_option['gutentag' . '_ilightbox_path'], 
		'ilightbox_infinite' => 				$cmsmasters_option['gutentag' . '_ilightbox_infinite'], 
		'ilightbox_aspect_ratio' => 			$cmsmasters_option['gutentag' . '_ilightbox_aspect_ratio'], 
		'ilightbox_mobile_optimizer' => 		$cmsmasters_option['gutentag' . '_ilightbox_mobile_optimizer'], 
		'ilightbox_max_scale' => 				$cmsmasters_option['gutentag' . '_ilightbox_max_scale'], 
		'ilightbox_min_scale' => 				$cmsmasters_option['gutentag' . '_ilightbox_min_scale'], 
		'ilightbox_inner_toolbar' => 			$cmsmasters_option['gutentag' . '_ilightbox_inner_toolbar'], 
		'ilightbox_smart_recognition' => 		$cmsmasters_option['gutentag' . '_ilightbox_smart_recognition'], 
		'ilightbox_fullscreen_one_slide' => 	$cmsmasters_option['gutentag' . '_ilightbox_fullscreen_one_slide'], 
		'ilightbox_fullscreen_viewport' => 		$cmsmasters_option['gutentag' . '_ilightbox_fullscreen_viewport'], 
		'ilightbox_controls_toolbar' => 		$cmsmasters_option['gutentag' . '_ilightbox_controls_toolbar'], 
		'ilightbox_controls_arrows' => 			$cmsmasters_option['gutentag' . '_ilightbox_controls_arrows'], 
		'ilightbox_controls_fullscreen' => 		$cmsmasters_option['gutentag' . '_ilightbox_controls_fullscreen'], 
		'ilightbox_controls_thumbnail' => 		$cmsmasters_option['gutentag' . '_ilightbox_controls_thumbnail'], 
		'ilightbox_controls_keyboard' => 		$cmsmasters_option['gutentag' . '_ilightbox_controls_keyboard'], 
		'ilightbox_controls_mousewheel' => 		$cmsmasters_option['gutentag' . '_ilightbox_controls_mousewheel'], 
		'ilightbox_controls_swipe' => 			$cmsmasters_option['gutentag' . '_ilightbox_controls_swipe'], 
		'ilightbox_controls_slideshow' => 		$cmsmasters_option['gutentag' . '_ilightbox_controls_slideshow'], 
		'ilightbox_close_text' => 				esc_html__('Close', 'gutentag'), 
		'ilightbox_enter_fullscreen_text' => 	esc_html__('Enter Fullscreen (Shift+Enter)', 'gutentag'), 
		'ilightbox_exit_fullscreen_text' => 	esc_html__('Exit Fullscreen (Shift+Enter)', 'gutentag'), 
		'ilightbox_slideshow_text' => 			esc_html__('Slideshow', 'gutentag'), 
		'ilightbox_next_text' => 				esc_html__('Next', 'gutentag'), 
		'ilightbox_previous_text' => 			esc_html__('Previous', 'gutentag'), 
		'ilightbox_load_image_error' => 		esc_html__('An error occurred when trying to load photo.', 'gutentag'), 
		'ilightbox_load_contents_error' => 		esc_html__('An error occurred when trying to load contents.', 'gutentag'), 
		'ilightbox_missing_plugin_error' => 	esc_html__("The content your are attempting to view requires the <a href='{pluginspage}' target='_blank'>{type} plugin<\/a>.", 'gutentag') 
	);
	...
	wp_enqueue_script('gutentag-script', get_template_directory_uri() . '/js/jquery.script.js', array('jquery'), '1.0.0', true);
	
	wp_localize_script('gutentag-script', 'cmsmasters_script', $cmsmasters_localize_array);
	
	wp_enqueue_script('gutentag-theme-script', get_template_directory_uri() . '/theme-framework/theme-style' . CMSMASTERS_THEME_STYLE . '/js/jquery.theme-script.js', array('jquery', 'gutentag-script'), '1.0.0', true);
	...
	$cmsmasters_custom_js = stripslashes($cmsmasters_option['gutentag' . '_custom_js']);
	
	wp_add_inline_script('gutentag-script', $cmsmasters_custom_js);
	
	
	if (CMSMASTERS_DEVELOPER_MODE) {
		gutentag_regenerate_styles();
	}
}

add_action('wp_enqueue_scripts', 'gutentag_register_js_scripts');



/* Fonts Generate Function */
if (!function_exists('gutentag_theme_fonts_generate')) {

function gutentag_theme_fonts_generate() {
	$cmsmasters_option = gutentag_get_global_options();
	...
	foreach ($font_fields as $font_field) {
		$font_option = 'gutentag' . '_' . $font_field . '_font_google_font';
...
add_action('wp_enqueue_scripts', 'gutentag_theme_fonts_generate');
add_action('enqueue_block_editor_assets', 'gutentag_theme_fonts_generate');
...
function cmsmasters_theme_font($fonts, $font_name = '') {
	...
	if ( 
		...
		if ($local_fonts != '' && $font_name == '') {
			wp_add_inline_style('gutentag-style', $local_fonts);
		}
		...
		if ($web_fonts != '') {
			...
			if (
				isset($cmsmasters_option['gutentag' . '_google_web_fonts_subset']) && 
				is_array($cmsmasters_option['gutentag' . '_google_web_fonts_subset'])
			) {
				$web_fonts_subset_array = $cmsmasters_option['gutentag' . '_google_web_fonts_subset'];
			} else {
...
function gutentag_get_google_font($font) {
	if ($font != '') {
		if (strpos($font, ':')) {
...
function gutentag_the_widgets_init() {
    ...
    register_sidebar(
        array(
            'name' => esc_html__('Sidebar', 'gutentag'), 
            'id' => 'sidebar_default', 
            'description' => esc_html__('Widgets in this area will be shown in all left and right sidebars till you don\'t use custom sidebar. To display the sidebar please choose the Right or Left Layout Type in the Theme Settings - General - Content options.', 'gutentag'), 
    ...
    register_sidebar(
        array(
            'name' => esc_html__('Bottom Sidebar', 'gutentag'), 
            'id' => 'sidebar_bottom', 
            'description' => esc_html__('Widgets in this area will be shown at the bottom of middle block below the content and middle sidebar, but above footer. To display Bottom Sidebar please enable it in the Theme Settings - General - Content - Bottom Sidebar Visibility by Default. You can also display it on concrete page in the Page Layout options.', 'gutentag'), 
            'before_widget' => '<aside id="%1$s" class="widget %2$s">', 
            'after_widget' => '</aside>', 
            'before_title' => '<h3 class="widgettitle">', 
            'after_title' => '</h3>'
    ...
    register_sidebar(
        array(
            'name' => esc_html__('Archive Sidebar', 'gutentag'), 
            'id' => 'sidebar_archive', 
            'description' => esc_html__('Widgets in this area will be shown in all left and right sidebars on archives pages. To display the sidebar please choose the Right or Left Layout Type in the Theme Settings - General - Content options.', 'gutentag'), 
            'before_widget' => '<aside id="%1$s" class="widget %2$s">', 
            'after_widget' => '</aside>', 
            'before_title' => '<h3 class="widgettitle">', 
            'after_title' => '</h3>'
    ...
    register_sidebar(
        array(
            'name' => esc_html__('Search Sidebar', 'gutentag'), 
            'id' => 'sidebar_search', 
            'description' => esc_html__('Widgets in this area will be shown in left or right sidebar on search page. To display the sidebar please choose the Right or Left Layout Type in the Theme Settings - General - Content options.', 'gutentag'), 
            'before_widget' => '<aside id="%1$s" class="widget %2$s">', 
            'after_widget' => '</aside>', 
            'before_title' => '<h3 class="widgettitle">', 
            'after_title' => '</h3>'
	...
	if (isset($cmsmasters_option['gutentag' . '_sidebar']) && sizeof($cmsmasters_option['gutentag' . '_sidebar']) > 0) {
		foreach ($cmsmasters_option['gutentag' . '_sidebar'] as $sidebar) {
			register_sidebar(array( 
				'name' => $sidebar, 
				'id' => generateSlug($sidebar, 45), 
				'description' => esc_html__('Custom sidebar created with cmsmasters admin panel.', 'gutentag'), 
				'before_widget' => '<aside id="%1$s" class="widget %2$s">', 
				'after_widget' => '</aside>', 
				'before_title' => '<h3 class="widgettitle">', 
				'after_title' => '</h3>' 
...
add_action('widgets_init', 'gutentag_the_widgets_init');



/* Register Showing Home Page on Default WordPress Pages Menu */
function gutentag_page_menu_args($args) {
    $args['show_home'] = true;
...
add_filter('wp_page_menu_args', 'gutentag_page_menu_args');
...
if (function_exists('add_theme_support')) {
	...
	function gutentag_add_post_type_support_project($post) {
	...
	add_action('load-post.php', 'gutentag_add_post_type_support_project');
	
	add_action('load-post-new.php', 'gutentag_add_post_type_support_project');
	...
	add_filter('image_size_names_choose', 'gutentag_select_image_size');
}



/* Add Image Thumbnails Size to the List */
function gutentag_select_image_size($sizes) {
	$thumbnail_list = cmsmasters_image_thumbnail_list();
...
function gutentag_add_editor_styles() {
...
if (version_compare($cmsmasters_wp_version, '5', '<') && !function_exists('is_gutenberg_page')) {
	add_action('init', 'gutentag_add_editor_styles');
}



/* Register Removing 'More Text' From Excerpt */
function gutentag_new_excerpt_more($more) {
	return '...';
}

add_filter('excerpt_more', 'gutentag_new_excerpt_more');
...
function gutentag_excerpt($length = 55, $show = true) {
	if ($show) {
...
function gutentag_post_author_archive($query) {
...
add_action('pre_get_posts', 'gutentag_post_author_archive');



/* Check Row p Wrapper */
function gutentag_rowcheck($content) {
...
function gutentag_generate_front_css() {
	$shortcodes_css = get_post_meta(get_the_ID(), 'cmsmasters_shortcodes_custom_css', true);
	
	
	wp_add_inline_style('gutentag-retina', $shortcodes_css);
}

add_action('wp_enqueue_scripts', 'gutentag_generate_front_css');
...
function gutentag_add_global_icons() {
	...
	if ($wp_filesystem) {
		...
		update_option('cmsmasters_' . 'gutentag' . '_icons', serialize($arr));
		
		update_option('cmsmasters_' . 'gutentag' . '_icons_custom', serialize($arr_custom));
	}
}
...
function cmsmasters_composer_icons() {
	...
	if ( 
		...
		$icons = get_option('cmsmasters_' . 'gutentag' . '_icons');
		
		$icons_custom = get_option('cmsmasters_' . 'gutentag' . '_icons_custom');
		...
		} elseif (wp_script_is('gutentag-lightbox-js', 'queue')) {
			wp_add_inline_script('gutentag-lightbox-js', $out, 'before');
		}
	}
}
...
function gutentag_regenerate_styles() {
	$custom_css_fonts = gutentag_theme_fonts();
	
	$custom_css_colors_primary = gutentag_theme_colors_primary();
	
	$custom_css_colors_secondary = gutentag_theme_colors_secondary();
	
	
	$custom_css = $custom_css_fonts . $custom_css_colors_primary . $custom_css_colors_secondary;
	
	
	gutentag_write_styles($custom_css);
}
...
function gutentag_write_styles($styles, $filename = '') {
	$upload_dir = wp_upload_dir();
	...
	$is_dir = gutentag_create_folder($style_dir);
	
	
	if ($is_dir === false) {
		update_option('cmsmasters_style_dir_writable_' . 'gutentag', 'false');
		
		update_option('cmsmasters_style_exists_' . 'gutentag', 'false');
	...
	$file = trailingslashit($style_dir) . (($filename != '') ? $filename : 'gutentag') . '.css';
	
	
	$created = gutentag_create_file($file, $styles);
	
	
	if ($created === true) {
		update_option('cmsmasters_style_dir_writable_' . 'gutentag', 'true');
		
		update_option('cmsmasters_style_exists_' . 'gutentag', 'true');
	}
}
...
function gutentag_create_folder(&$folder, $addindex = true) {
...
function gutentag_create_file($file, $content = '', $verifycontent = true) {
	global $wp_filesystem;
...
function gutentag_theme_bg_styles() {
	global $post;
	...
	if ($cmsmasters_option['gutentag' . '_theme_layout'] == 'boxed') {
		...
		if ($cmsmasters_bg_default == 'false') {
			...
			$cmsmasters_bg_col = $cmsmasters_option['gutentag' . '_bg_col'];
			$cmsmasters_bg_img_enable = $cmsmasters_option['gutentag' . '_bg_img_enable'];
			$cmsmasters_bg_img_str = $cmsmasters_option['gutentag' . '_bg_img'];
			$cmsmasters_bg_pos = $cmsmasters_option['gutentag' . '_bg_pos'];
			$cmsmasters_bg_rep = $cmsmasters_option['gutentag' . '_bg_rep'];
			$cmsmasters_bg_att = $cmsmasters_option['gutentag' . '_bg_att'];
			$cmsmasters_bg_size = $cmsmasters_option['gutentag' . '_bg_size'];
		}
	...
	wp_add_inline_style('gutentag-style', $out);
}

add_action('wp_enqueue_scripts', 'gutentag_theme_bg_styles');



/* Get Logo Function */
function gutentag_logo() {
	$cmsmasters_option = gutentag_get_global_options();
	
	
	if ($cmsmasters_option['gutentag' . '_logo_type'] == 'text') {
		if ($cmsmasters_option['gutentag' . '_logo_title'] != '') {
			$blog_title = stripslashes($cmsmasters_option['gutentag' . '_logo_title']);
		} else {
			$blog_title = (get_bloginfo('name')) ? get_bloginfo('name') : 'Gutentag';
		}
		
		
		if ($cmsmasters_option['gutentag' . '_logo_subtitle'] != '') {
			$blog_descr = stripslashes($cmsmasters_option['gutentag' . '_logo_subtitle']);
		} else {
			$blog_descr = (get_bloginfo('description')) ? get_bloginfo('description') : esc_html__('Default Logo Subtitle', 'gutentag');
		}
		...
		echo '<a href="' . esc_url(home_url('/')) . '" title="' . esc_attr($blog_title) . '" class="logo">' . "\n\t" . 
			'<span class="logo_text_wrap">' . 
				...
				($cmsmasters_option['gutentag' . '_logo_subtitle'] ? '<span class="title_text">' . esc_html($blog_descr) . '</span>' : '') . 
			'</span>' . 
		'</a>';
	} else {
		...
		if ($cmsmasters_option['gutentag' . '_logo_url'] == '') {
			...
			$logo_img = explode('|', $cmsmasters_option['gutentag' . '_logo_url']);
			...
			if ($cmsmasters_option['gutentag' . '_logo_url_retina'] != '') {
				$logo_img_retina = explode('|', $cmsmasters_option['gutentag' . '_logo_url_retina']);
...
/* Logo Styles */
function gutentag_theme_logo_styles() {
	$cmsmasters_option = gutentag_get_global_options();
	...
	if ($cmsmasters_option['gutentag' . '_logo_type'] == 'text') {
		if ($cmsmasters_option['gutentag' . '_logo_custom_color']) {
			$out .= "
				#header a.logo span.title {
					" . cmsmasters_color_css('color', $cmsmasters_option['gutentag' . '_logo_title_color']) . "
				}
				
				#header a.logo span.title_text {
					" . cmsmasters_color_css('color', $cmsmasters_option['gutentag' . '_logo_subtitle_color']) . "
				}
			";
		}
	} else {
		...
		$header_mid_height = (($cmsmasters_option['gutentag' . '_header_mid_height'] !== '') ? $cmsmasters_option['gutentag' . '_header_mid_height'] : $defaults[$tab]['gutentag' . '_header_mid_height']);
...
add_action('wp_enqueue_scripts', 'gutentag_theme_logo_styles');



/* Get Footer Logo Function */
function gutentag_footer_logo($cmsmasters_option) {
	...
	if ($cmsmasters_option['gutentag' . '_footer_logo_url'] == '') {
		...
		$footer_logo_img = explode('|', $cmsmasters_option['gutentag' . '_footer_logo_url']);
		...
		if ($cmsmasters_option['gutentag' . '_footer_logo_url_retina'] != '') {
			$footer_logo_img_retina = explode('|', $cmsmasters_option['gutentag' . '_footer_logo_url_retina']);
...
function gutentag_social_icons() {
	$out = '';
...
<div class=\"social_wrap\">
	<div class=\"social_wrap_inner\">
		...
		foreach ($cmsmasters_option['gutentag' . '_social_icons'] as $cmsmasters_social_icons) {
	...
	echo gutentag_return_content($out);
}
...
function gutentag_get_comments($class = false, $show = false, $add_html = false) { 
	$out = '';
	
	if ($add_html) {
		$text = (get_comments_number() == '1') ? esc_html__('comment', 'gutentag') : esc_html__('comments', 'gutentag');
	} else {
		$text = '';
	}
	...
	if (comments_open()) {
		$out .= '<span class="cmsmasters_comments' . ($class ? ' ' . $class : '') . '">' . 
			'<a class="cmsmasters_theme_icon_comment" href="' . esc_url(get_comments_link()) . '" title="' . esc_attr__('Comment on', 'gutentag') . ' ' . esc_attr(get_the_title()) . '">' . 
...
/* Get Category List */
function gutentag_get_the_category_list($cmsmasters_id, $taxonomy, $sep = '', $before = '', $after = '', $taxonomy_class = false) {
...
function gutentag_theme_page_layout_scheme() {
	$cmsmasters_option = gutentag_get_global_options();
	...
	} elseif (CMSMASTERS_TRIBE_EVENTS && tribe_is_event_query() && isset($cmsmasters_option['gutentag' . '_events_layout'])) {
		$cmsmasters_layout = $cmsmasters_option['gutentag' . '_events_layout'];
	} elseif (is_archive() || is_home()) {
		$cmsmasters_layout = $cmsmasters_option['gutentag' . '_archives_layout'];
	} elseif (is_search()) {
		$cmsmasters_layout = $cmsmasters_option['gutentag' . '_search_layout'];
	} else {
		$cmsmasters_layout = $cmsmasters_option['gutentag' . '_other_layout'];
	}
	
	
	if ($cmsmasters_layout == '') {
		$cmsmasters_layout = $cmsmasters_option['gutentag' . '_layout'];
	}
	...
	return array($cmsmasters_layout);
}



/* Return content */
function gutentag_return_content($content) {
	return $content;
}
...
function gutentag_global_shortcodes_styles_move($content) {
	return preg_replace("/(?<!['\"])<style.*?>([^`]*?)<\/style>/", '', $content);
}


function gutentag_row_checker($data) {
	$out = gutentag_rowcheck($data);
	
	return $out;
}

add_filter('the_content', 'gutentag_row_checker', 10, 2);
	...
	if( wp_verify_nonce($nonce, 'cmsmasters_ajax_like-nonce') ){
		...
		if ($post_ID != '') {
			...
			if (isset($_COOKIE['like-' . $post_ID]) || count($ipCheck) != 0) {
				...
				if ($add_html == 'true') {
					$text = ($plusLike == '1') ? esc_html__('like', 'gutentag') : esc_html__('likes', 'gutentag');
				} else {
					$text = '';
				}
...
function cmsmasters_ajax_apply_theme_style_callback() {
	...
	if (wp_verify_nonce($nonce, 'cmsmasters_ajax_apply_theme_style-nonce')) {
		if (isset($_POST['theme_style'])) {
			update_option('cmsmasters_gutentag_theme_style', $_POST['theme_style']);
		}
...
function gutentag_theme_style_change() {
	if (get_option('cmsmasters_gutentag_theme_style')) {
		return;
	} else {
		if (!CMSMASTERS_THEME_STYLE_COMPATIBILITY) {
			add_option('cmsmasters_gutentag_theme_style', '', '', 'yes');
		}

		gutentag_add_global_options();
		
		gutentag_add_global_icons();
		
		gutentag_regenerate_styles();
	}
}

add_action('init', 'gutentag_theme_style_change');
...
function cmsmasters_ajax_reset_settings_callback() {
	...
	if (wp_verify_nonce($nonce, 'cmsmasters_ajax_reset_settings-nonce')) {
		gutentag_add_global_options(true);
...
function cmsmasters_ajax_export_settings_callback() {
	...
	if (wp_verify_nonce($nonce, 'cmsmasters_ajax_export_settings-nonce')) {
		$cmsmasters_global_settings = array( 
			'cmsmasters_options_' . 'gutentag' . CMSMASTERS_THEME_STYLE . '_general', 
			'cmsmasters_options_' . 'gutentag' . CMSMASTERS_THEME_STYLE . '_bg', 
			'cmsmasters_options_' . 'gutentag' . CMSMASTERS_THEME_STYLE . '_header', 
			'cmsmasters_options_' . 'gutentag' . CMSMASTERS_THEME_STYLE . '_content', 
			'cmsmasters_options_' . 'gutentag' . CMSMASTERS_THEME_STYLE . '_footer', 
			'cmsmasters_options_' . 'gutentag' . CMSMASTERS_THEME_STYLE . '_font_content', 
			'cmsmasters_options_' . 'gutentag' . CMSMASTERS_THEME_STYLE . '_font_link', 
			'cmsmasters_options_' . 'gutentag' . CMSMASTERS_THEME_STYLE . '_font_nav', 
			'cmsmasters_options_' . 'gutentag' . CMSMASTERS_THEME_STYLE . '_font_heading', 
			'cmsmasters_options_' . 'gutentag' . CMSMASTERS_THEME_STYLE . '_font_other', 
			'cmsmasters_options_' . 'gutentag' . CMSMASTERS_THEME_STYLE . '_element_sidebar', 
			'cmsmasters_options_' . 'gutentag' . CMSMASTERS_THEME_STYLE . '_element_icon', 
			'cmsmasters_options_' . 'gutentag' . CMSMASTERS_THEME_STYLE . '_element_lightbox', 
			'cmsmasters_options_' . 'gutentag' . CMSMASTERS_THEME_STYLE . '_element_sitemap', 
			'cmsmasters_options_' . 'gutentag' . CMSMASTERS_THEME_STYLE . '_element_error', 
			'cmsmasters_options_' . 'gutentag' . CMSMASTERS_THEME_STYLE . '_element_code', 
			'cmsmasters_options_' . 'gutentag' . CMSMASTERS_THEME_STYLE . '_element_recaptcha', 
			'cmsmasters_options_' . 'gutentag' . CMSMASTERS_THEME_STYLE . '_single_post', 
			'cmsmasters_options_' . 'gutentag' . CMSMASTERS_THEME_STYLE . '_single_project', 
			'cmsmasters_options_' . 'gutentag' . CMSMASTERS_THEME_STYLE . '_single_profile'
		);
		...
		foreach (gutentag_all_color_schemes_list() as $key => $value) {
			$cmsmasters_global_colors[] = 'cmsmasters_options_' . 'gutentag' . CMSMASTERS_THEME_STYLE . '_color_' . $key;
		}
		...
		echo gutentag_return_content($result);
