...
if (!function_exists('cmsmasters_fonts_list')) {
	function cmsmasters_fonts_list() {
		...
		if (isset($cmsmasters_option['gutentag' . '_google_web_fonts']) && is_array($cmsmasters_option['gutentag' . '_google_web_fonts'])) {
			$google_web_fonts_array = $cmsmasters_option['gutentag' . '_google_web_fonts'];
		...
		$fonts = array( 
			'' => esc_html__('None', 'gutentag'), 
			'local' => $local_fonts, 
			'web' => $google_web_fonts 
		);
		
		
		return apply_filters('gutentag_google_fonts_list_filter', $fonts);
	}
}
...
if (!function_exists('cmsmasters_text_transform_list')) {
	function cmsmasters_text_transform_list() {
		$list = array( 
			...
			'uppercase' => esc_html__('uppercase', 'gutentag'), 
			'lowercase' => esc_html__('lowercase', 'gutentag'), 
			'capitalize' => esc_html__('capitalize', 'gutentag'), 
		);
...
if (!function_exists('cmsmasters_image_thumbnail_list')) {
	function cmsmasters_image_thumbnail_list() {
		$list = gutentag_get_image_thumbnail_list();
...
if (!function_exists('cmsmasters_color_schemes_list')) {
	function cmsmasters_color_schemes_list() {
		$list = gutentag_all_color_schemes_list();
