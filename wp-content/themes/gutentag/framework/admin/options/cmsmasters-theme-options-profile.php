...
if (!function_exists('gutentag_get_custom_profile_meta_fields')) {
function gutentag_get_custom_profile_meta_fields() {
	...
	$cmsmasters_global_profile_post_title = (isset($cmsmasters_option['gutentag' . '_profile_post_title']) && $cmsmasters_option['gutentag' . '_profile_post_title'] !== '') ? (($cmsmasters_option['gutentag' . '_profile_post_title'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_profile_post_details_title = (isset($cmsmasters_option['gutentag' . '_profile_post_details_title']) && $cmsmasters_option['gutentag' . '_profile_post_details_title'] !== '') ? $cmsmasters_option['gutentag' . '_profile_post_details_title'] : '';
	
	$cmsmasters_global_profile_post_share_box = (isset($cmsmasters_option['gutentag' . '_profile_post_share_box']) && $cmsmasters_option['gutentag' . '_profile_post_share_box'] !== '') ? (($cmsmasters_option['gutentag' . '_profile_post_share_box'] == 1) ? 'true' : 'false') : 'true';
	...
	$tabs_array['cmsmasters_profile'] = array( 
		'label' => esc_html__('Profile', 'gutentag'), 
	...
	$custom_profile_meta_fields = array( 
		...
		array( 
			'label'	=> esc_html__('Profile Title', 'gutentag'), 
		...
		array( 
			'label'	=> esc_html__('Subtitle', 'gutentag'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Details Title', 'gutentag'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Social Icons', 'gutentag'), 
			'desc'	=> esc_html__('Add social icons for this profile', 'gutentag'), 
		...
		array( 
			'label'	=> esc_html__('Profile Info', 'gutentag'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 1 Title', 'gutentag'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 1', 'gutentag'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 2 Title', 'gutentag'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 2', 'gutentag'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 3 Title', 'gutentag'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 3', 'gutentag'), 
			'desc'	=> '', 
