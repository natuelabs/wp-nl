...
if (!function_exists('gutentag_get_custom_post_meta_fields')) {
function gutentag_get_custom_post_meta_fields() {
	$cmsmasters_option = gutentag_get_global_options();
	
	
	$cmsmasters_global_blog_post_layout = (isset($cmsmasters_option['gutentag' . '_blog_post_layout']) && $cmsmasters_option['gutentag' . '_blog_post_layout'] !== '') ? $cmsmasters_option['gutentag' . '_blog_post_layout'] : 'r_sidebar';
	...
	$cmsmasters_global_blog_post_title = (isset($cmsmasters_option['gutentag' . '_blog_post_title']) && $cmsmasters_option['gutentag' . '_blog_post_title'] !== '') ? (($cmsmasters_option['gutentag' . '_blog_post_title'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_blog_post_share_box = (isset($cmsmasters_option['gutentag' . '_blog_post_share_box']) && $cmsmasters_option['gutentag' . '_blog_post_share_box'] !== '') ? (($cmsmasters_option['gutentag' . '_blog_post_share_box'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_blog_post_author_box = (isset($cmsmasters_option['gutentag' . '_blog_post_author_box']) && $cmsmasters_option['gutentag' . '_blog_post_author_box'] !== '') ? (($cmsmasters_option['gutentag' . '_blog_post_author_box'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_blog_more_posts_box = (isset($cmsmasters_option['gutentag' . '_blog_more_posts_box'])) ? $cmsmasters_option['gutentag' . '_blog_more_posts_box'] : 'related';
	...
	$tabs_array['cmsmasters_post'] = array( 
		'label' => esc_html__('Post', 'gutentag'), 
	...
	$custom_post_meta_fields = array( 
		...
		array( 
			'label'	=> esc_html__('Don\'t Show Featured Image in Open Post', 'gutentag'), 
			'desc'	=> esc_html__('Don\'t Show', 'gutentag'), 
		...
		array( 
			'label'	=> esc_html__('Post Image', 'gutentag'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Post Gallery', 'gutentag'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Audio Links', 'gutentag'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Post Title', 'gutentag'), 
		...
		array( 
			'label'	=> esc_html__('About Author Box', 'gutentag'), 
			'desc'	=> esc_html__('Show', 'gutentag'), 
		...
		array( 
			'label'	=> esc_html__('More Posts Box', 'gutentag'), 
			'desc'	=> '', 
			...
			'options' => array( 
				'related' => array( 
					'label' => esc_html__('Show Related Tab', 'gutentag'), 
					'value'	=> 'related' 
				), 
				'popular' => array( 
					'label' => esc_html__('Show Popular Tab', 'gutentag'), 
					'value'	=> 'popular' 
				), 
				'recent' => array( 
					'label' => esc_html__('Show Recent Tab', 'gutentag'), 
					'value'	=> 'recent' 
				), 
				'hide' => array( 
					'label' => esc_html__('Hide More Posts Box', 'gutentag'), 
					'value'	=> 'hide' 
				) 
			) 
		),
