 ...
 * @version 	1.0.0
 * 
 * Visual Portfolio Admin Options
...
/* Filter for Options */
function gutentag_woocommerce_meta_fields($custom_all_meta_fields) {
...
add_filter('get_custom_all_meta_fields_filter', 'gutentag_woocommerce_meta_fields');
