...
<?php gutentag_get_header_search_form($cmsmasters_option); ?>

<!-- Start Page -->
<div id="page" class="<?php gutentag_get_page_classes($cmsmasters_option); ?>hfeed site">
