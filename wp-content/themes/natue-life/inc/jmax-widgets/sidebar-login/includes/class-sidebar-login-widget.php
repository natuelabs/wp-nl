...
class Sidebar_Login_Widget extends WP_Widget {
    ...
    public function Sidebar_Login_Widget() {
        ...
        parent::__construct( 'wp_sidebarlogin', __( 'Sidebar Login', 'sidebar_login' ), $widget_ops );
    }
    ...
    public function widget( $args, $instance ) {
		...
		if ( is_user_logged_in() ) {
			...
			if ( $show_avatar == 1 )
				echo '<div class="avatar_container">' . get_avatar( $this->user->ID, apply_filters( 'sidebar_login_widget_avatar_size', 75 ) ) . '</div>';
